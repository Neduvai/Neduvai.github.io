  ...
  var bar = new Promise((resolve, reject) => {
    ...
    querySnapshot.forEach((doc) => {
      ...
      htmlCode=htmlCode +`<div onclick="window.location.href='./detailed?name=${doc.id}'" class="card" style="display:flex;flex-direction:column;" >
              ...
              <span style="display:flex;flex-direction:column;padding:1.5vmax;line-height:1;">
                <span style="font-family:ATB;font-size:2vmax;margin-left:2vmin;max-height:1vmin;">${doc.data().title}</span><br>
                <span style="display:flex; flex-direction:row;max-height:2vmin;margin-left:4vmin;">
